...
(function() {
  ...
  this.FacePP = (function() {
    ...
    function FacePP(apiKey, apiSecret, options) {
      ...
      this.sessionCheck = bind(this.sessionCheck, this);
      defaults = {
      ...
      if ((requestCapacity = options.concurrency) > 0) {
        queue = [];
        scheduleRequest = (function(_this) {
          return function() {
            var apiMethod, callback, data, ref;
            if (requestCapacity > 0 && queue.length > 0) {
              --requestCapacity;
              ref = queue.shift(), apiMethod = ref[0], data = ref[1], callback = ref[2];
    ...
    FacePP.prototype.requestAsync = function(apiMethod, data, callback) {
      data['async'] = 'true';
      this.request(apiMethod, data, (function(_this) {
        return function(err, result) {
          if (err) {
            callback(err, result);
          } else {
...
//# sourceMappingURL=facepp-sdk.js.map
